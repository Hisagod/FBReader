...
bool OleStorage::init(shared_ptr<ZLInputStream> stream, std::size_t streamSize) {
	...
	static const char OLE_SIGN[] = {static_cast<char>(0xD0), static_cast<char>(0xCF), 0x11, static_cast<char>(0xE0), static_cast<char>(0xA1), static_cast<char>(0xB1), 0x1A, static_cast<char>(0xE1), 0};
